...
public class GoodsDetailEntity implements Serializable {
    ...
    private GoodStoreBean goodStoreBean;
    ...
    public GoodStoreBean getGoodStoreBean() {
        return goodStoreBean;
    }

    public void setGoodStoreBean(GoodStoreBean goodStoreBean) {
        this.goodStoreBean = goodStoreBean;
    }
    ...
    public long getLsat_modify() {
        return lsat_modify;
    }

    public void setLsat_modify(long lsat_modify) {
        this.lsat_modify = lsat_modify;
    }
